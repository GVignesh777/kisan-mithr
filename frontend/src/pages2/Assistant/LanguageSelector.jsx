...
const LanguageSelector = ({ language, setLanguage }) => {
  return (
    <div className="bg-green-900/40 backdrop-blur-md border border-green-400/10 shadow-[0_4px_30px_rgba(0,0,0,0.3)] p-1 rounded-xl flex items-center gap-1">
      ...
      >
        <option value="en-IN" className="bg-zinc-900 text-white">English</option>
        <option value="te-IN" className="bg-zinc-900 text-white">తెలుగు (Telugu)</option>
        <option value="hi-IN" className="bg-zinc-900 text-white">हिंदी (Hindi)</option>
      </select>
    </div>
  );
};
